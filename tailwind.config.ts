    ...
    extend: {
      ...
      colors: {
        ...
        uncertain: {
          ...
          light: "hsl(var(--uncertain-light))",
        },
        hallucinated: {
          DEFAULT: "hsl(var(--hallucinated))",
          foreground: "hsl(var(--hallucinated-foreground))",
          light: "hsl(var(--hallucinated-light))",
        },
        trust: {
